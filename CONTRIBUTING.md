...
For complete attribution and licensing information for parts of the project that are not in the public domain, see the [LICENSE](https://github.com/GSA/fedramp-ai/blob/LICENSE.md).

### The rest of this project is in the public domain

The rest of this project is in the worldwide [public domain](https://github.com/GSA/fedramp-ai/blob/LICENSE.md#the-rest-of-this-project-is-in-the-worldwide-public-domain).
